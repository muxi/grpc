...
static void request_with_payload_template(
    ...
    grpc_stream_compression_algorithm default_client_channel_compression_algorithm,
    grpc_stream_compression_algorithm default_server_channel_compression_algorithm,
  ...
  GPR_ASSERT(GPR_BITCOUNT(grpc_call_test_only_get_stream_encodings_accepted_by_peer(
...
static void test_invoke_request_with_compressed_payload(
  ...
  request_with_payload_template(
      ...
      GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, NULL,
      false, /* ignored */
...
static void test_invoke_request_with_send_message_before_initial_metadata(
  ...
  request_with_payload_template(
      ...
      0, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_GZIP, NULL,
      false, /* ignored */
...
static void test_invoke_request_with_server_level(
  ...
  request_with_payload_template(config, "test_invoke_request_with_server_level",
                                0, GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_GZIP,
                                /* ignored */ NULL, true,
                                GRPC_STREAM_COMPRESS_LEVEL_HIGH, false, false, GRPC_COMPRESS_NONE);
}
...
static void test_invoke_request_with_compressed_payload_md_override(
  ...
  request_with_payload_template(
      ...
      GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_NONE, &gzip_compression_override, false,
  ...
  request_with_payload_template(
      ...
      GRPC_STREAM_COMPRESS_GZIP, GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_NONE,
...
static void test_stream_compression_override_message_compression(grpc_end2end_test_config config) {
  grpc_stream_compression_level level = GRPC_STREAM_COMPRESS_LEVEL_MED;
  request_with_payload_template(
      config, "test_stream_compression_override_message_compression", 0, GRPC_STREAM_COMPRESS_NONE,
      GRPC_STREAM_COMPRESS_NONE, GRPC_STREAM_COMPRESS_NONE, grpc_stream_compression_algorithm_for_level(level, (1u << GRPC_STREAM_COMPRESS_ALGORITHMS_COUNT) - 1), /* ignored */ NULL, true, level, false, true, GRPC_COMPRESS_GZIP);
}
