...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/iomgr/tcp_cfstream.h )
  ...
  s.files += %w( src/core/lib/iomgr/error_apple.mm )
  ...
  s.files += %w( src/core/lib/iomgr/tcp_cfstream.mm )
  s.files += %w( src/core/lib/iomgr/tcp_client_cfstream.mm )
