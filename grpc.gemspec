...
Gem::Specification.new do |s|
  ...
  s.files += %w( third_party/libuv/include/uv.h )
  s.files += %w( third_party/libuv/include/uv/darwin.h )
  s.files += %w( third_party/libuv/include/uv/errno.h )
  s.files += %w( third_party/libuv/include/uv/linux.h )
  s.files += %w( third_party/libuv/include/uv/threadpool.h )
  s.files += %w( third_party/libuv/include/uv/tree.h )
  s.files += %w( third_party/libuv/include/uv/unix.h )
  s.files += %w( third_party/libuv/include/uv/version.h )
  s.files += %w( third_party/libuv/include/uv/win.h )
  s.files += %w( third_party/libuv/src/fs-poll.c )
  s.files += %w( third_party/libuv/src/heap-inl.h )
  s.files += %w( third_party/libuv/src/idna.c )
  s.files += %w( third_party/libuv/src/idna.h )
  s.files += %w( third_party/libuv/src/inet.c )
  s.files += %w( third_party/libuv/src/queue.h )
  s.files += %w( third_party/libuv/src/random.c )
  s.files += %w( third_party/libuv/src/strscpy.c )
  s.files += %w( third_party/libuv/src/strscpy.h )
  s.files += %w( third_party/libuv/src/threadpool.c )
  s.files += %w( third_party/libuv/src/timer.c )
  s.files += %w( third_party/libuv/src/unix/async.c )
  s.files += %w( third_party/libuv/src/unix/atomic-ops.h )
  s.files += %w( third_party/libuv/src/unix/bsd-ifaddrs.c )
  s.files += %w( third_party/libuv/src/unix/core.c )
  s.files += %w( third_party/libuv/src/unix/darwin-proctitle.c )
  s.files += %w( third_party/libuv/src/unix/darwin.c )
  s.files += %w( third_party/libuv/src/unix/dl.c )
  s.files += %w( third_party/libuv/src/unix/fs.c )
  s.files += %w( third_party/libuv/src/unix/fsevents.c )
  s.files += %w( third_party/libuv/src/unix/getaddrinfo.c )
  s.files += %w( third_party/libuv/src/unix/getnameinfo.c )
  s.files += %w( third_party/libuv/src/unix/internal.h )
  s.files += %w( third_party/libuv/src/unix/kqueue.c )
  s.files += %w( third_party/libuv/src/unix/linux-core.c )
  s.files += %w( third_party/libuv/src/unix/linux-inotify.c )
  s.files += %w( third_party/libuv/src/unix/linux-syscalls.c )
  s.files += %w( third_party/libuv/src/unix/linux-syscalls.h )
  s.files += %w( third_party/libuv/src/unix/loop-watcher.c )
  s.files += %w( third_party/libuv/src/unix/loop.c )
  s.files += %w( third_party/libuv/src/unix/pipe.c )
  s.files += %w( third_party/libuv/src/unix/poll.c )
  s.files += %w( third_party/libuv/src/unix/process.c )
  s.files += %w( third_party/libuv/src/unix/procfs-exepath.c )
  s.files += %w( third_party/libuv/src/unix/proctitle.c )
  s.files += %w( third_party/libuv/src/unix/random-devurandom.c )
  s.files += %w( third_party/libuv/src/unix/random-getentropy.c )
  s.files += %w( third_party/libuv/src/unix/random-getrandom.c )
  s.files += %w( third_party/libuv/src/unix/random-sysctl-linux.c )
  s.files += %w( third_party/libuv/src/unix/signal.c )
  s.files += %w( third_party/libuv/src/unix/spinlock.h )
  s.files += %w( third_party/libuv/src/unix/stream.c )
  s.files += %w( third_party/libuv/src/unix/sysinfo-loadavg.c )
  s.files += %w( third_party/libuv/src/unix/tcp.c )
  s.files += %w( third_party/libuv/src/unix/thread.c )
  s.files += %w( third_party/libuv/src/unix/tty.c )
  s.files += %w( third_party/libuv/src/unix/udp.c )
  s.files += %w( third_party/libuv/src/uv-common.c )
  s.files += %w( third_party/libuv/src/uv-common.h )
  s.files += %w( third_party/libuv/src/uv-data-getter-setters.c )
  s.files += %w( third_party/libuv/src/version.c )
  s.files += %w( third_party/libuv/src/win/async.c )
  s.files += %w( third_party/libuv/src/win/atomicops-inl.h )
  s.files += %w( third_party/libuv/src/win/core.c )
  s.files += %w( third_party/libuv/src/win/detect-wakeup.c )
  s.files += %w( third_party/libuv/src/win/dl.c )
  s.files += %w( third_party/libuv/src/win/error.c )
  s.files += %w( third_party/libuv/src/win/fs-event.c )
  s.files += %w( third_party/libuv/src/win/fs-fd-hash-inl.h )
  s.files += %w( third_party/libuv/src/win/fs.c )
  s.files += %w( third_party/libuv/src/win/getaddrinfo.c )
  s.files += %w( third_party/libuv/src/win/getnameinfo.c )
  s.files += %w( third_party/libuv/src/win/handle-inl.h )
  s.files += %w( third_party/libuv/src/win/handle.c )
  s.files += %w( third_party/libuv/src/win/internal.h )
  s.files += %w( third_party/libuv/src/win/loop-watcher.c )
  s.files += %w( third_party/libuv/src/win/pipe.c )
  s.files += %w( third_party/libuv/src/win/poll.c )
  s.files += %w( third_party/libuv/src/win/process-stdio.c )
  s.files += %w( third_party/libuv/src/win/process.c )
  s.files += %w( third_party/libuv/src/win/req-inl.h )
  s.files += %w( third_party/libuv/src/win/signal.c )
  s.files += %w( third_party/libuv/src/win/snprintf.c )
  s.files += %w( third_party/libuv/src/win/stream-inl.h )
  s.files += %w( third_party/libuv/src/win/stream.c )
  s.files += %w( third_party/libuv/src/win/tcp.c )
  s.files += %w( third_party/libuv/src/win/thread.c )
  s.files += %w( third_party/libuv/src/win/tty.c )
  s.files += %w( third_party/libuv/src/win/udp.c )
  s.files += %w( third_party/libuv/src/win/util.c )
  s.files += %w( third_party/libuv/src/win/winapi.c )
  s.files += %w( third_party/libuv/src/win/winapi.h )
  s.files += %w( third_party/libuv/src/win/winsock.c )
  s.files += %w( third_party/libuv/src/win/winsock.h )
