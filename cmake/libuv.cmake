...
if(gRPC_LIBUV_PROVIDER STREQUAL "module")
  ...
  if(EXISTS "${LIBUV_ROOT_DIR}/CMakeLists.txt")
    ...
    if(TARGET uv_a)
	  ...
	  message(WARNING "gRPC_LIBUV_PROVIDER is \"module\" but LIBUV_ROOT_DIR (${LIBUV_ROOT_DIR}) is wrong")
  endif()
...
elseif(gRPC_LIBUV_PROVIDER STREQUAL "package")
  # Use "CONFIG" as there is no built-in cmake module for libuv.
  find_package(uv_a REQUIRED CONFIG)
  if(TARGET uv_a::uv_a)
    set(_gRPC_LIBUV_LIBRARIES uv_a::uv_a)
  endif()
  set(_gRPC_FIND_LIBUV "if(NOT uv_a_FOUND)\n  find_package(libuv CONFIG)\nendif()")
endif()
